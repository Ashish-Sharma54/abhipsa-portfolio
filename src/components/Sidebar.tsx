      ...
      >
        <div className="flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-navy to-navy-light px-4 py-2.5 text-xs font-semibold text-gold shadow-lg shadow-navy/20 transition-all hover:shadow-xl hover:shadow-navy/30 hover:scale-105 cursor-pointer"
          >
            Download CV
